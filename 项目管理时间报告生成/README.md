...
- 自动读取Eagle库中的所有素材
- 从文件夹结构提取人员信息（第一层文件夹）
- **从文件添加日期提取时间信息**（使用Eagle文件基本信息中的"添加日期"）
- 从标签中提取项目名称
...
### v1.4.0 (2026-01-14) - 时间提取优化 ⭐
**核心功能变更**
- 📅 **时间来源变更**：从文件夹路径改为使用Eagle文件的"添加日期"
- ⏱️ **完成时间优化**：直接使用文件添加日期，无需依赖标签或文件夹命名
- 📊 **月份分类**：自动从添加日期提取年月信息
- 🎯 **时间筛选**：基于实际添加日期进行范围筛选，更加准确
...
### v1.4.0 (2026-01-14)
- 📅 时间提取改为使用文件添加日期（item.mtime）
- ⏱️ 完成时间直接使用添加日期，不再依赖标签提取
- 📊 月份分类从添加日期自动提取
- 🎯 时间范围筛选基于真实添加日期
